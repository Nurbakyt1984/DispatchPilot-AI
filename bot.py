...
Rules:
- is_rate_confirmation: true ONLY if this document is a Rate Confirmation / Load Confirmation / Carrier Confirmation (a broker document confirming a load and/or its rate, pickup, delivery). Set false for Bill of Lading (BOL), invoices, lumper receipts, insurance certificates, driver info sheets WITHOUT load data, and any other documents. If false, all other fields may be null.
