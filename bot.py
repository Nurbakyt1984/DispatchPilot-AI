...
- pickup_number: PU number / Pickup number / Reference number at the pickup location (labels: "PU", "Pickup #", "Reference number", "PU Number"). This is what the driver gives at the shipper gate. Use null if absent.
